    ...
    <?php
      ...
      while($rows = mysqli_fetch_assoc($data)){
        if($rows['image']!="")
          $img = $rows['image'];
        echo '
			<div class="card responsive ml-5 mt-2" align="center" style="height:90% ;width:100% ;opacity:0.9">
				<div class="card-header" align="center"><h3>'.$rows['title'].'</h3></div>
				<div class="row card-body">
					<div class="col-sm-5 ">
						<img src="'.$img.'" class="card-image-bottom rounded" style="height:100%;width:100%;max-height:300px" ></img>
					</div>
